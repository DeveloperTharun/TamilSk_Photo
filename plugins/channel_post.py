...
async def channel_post(client: Client, message: Message):
    ...
    link = f"https://copyright.rapidbots.workers.dev?start={base64_string}"

    reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("🔁 Share URL", url=f'https://telegram.me/share/url?url={link}')]])

    await reply_text.edit(f"href='{link}'Click Here To Download", reply_markup=reply_markup, disable_web_page_preview = True)
